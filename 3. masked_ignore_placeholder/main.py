...
def main():
    ...
    parser.add_argument('--time_slot', type=int, default=15, help='a time step is 15 mins')
    ...
    parser.add_argument('--train_file', default='./data/train.csv', help='train data CSV file')
    parser.add_argument('--val_test_file', default='./data/val_test.csv', help='validation and test data CSV file')
    ...
    parser.add_argument('--model_file', default='./data/model_I15NB_ign_placeholder.pt', help='save the model to disk')
    parser.add_argument('--log_file', default='./data/log_I15NB_ign_placeholder.txt', help='log file')
