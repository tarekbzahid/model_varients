...
parser.add_argument('--model_file', default='./data/model_I15NB_0_filled.pt', help='save the model to disk')
parser.add_argument('--log_file', default='./data/log_I15NB_0_filled.txt', help='log file')
